  ...
  public: {
    Tables: {
      course_access_grants: {
        Row: {
          ...
          access_status: "pending" | "granted" | "preserved" | "revoked" | "conflict"
          created_at: string
          updated_at: string
      ...
      // Added by hand for
      // supabase/migrations/20260820010000_course_landing_pages.sql — see the
      // note in Functions above.
      course_landings: {
        Row: {
          blocks: Json
          course_id: string
      ...
      // Added by hand for supabase/migrations/20260820000000_custom_domains.sql
      // — see the note in Functions above.
      custom_domains: {
        Row: {
          created_at: string
    ...
    Functions: {
      ...
      grant_course_access: {
        ...
        Returns: Database["public"]["Tables"]["course_access_grants"]["Row"]
      }
      claim_my_course_grants: {
      ...
      // Added by hand for
      // supabase/migrations/20260820010000_course_landing_pages.sql. This file
      // is normally generated by `supabase gen types`, which needs the migration
      // applied to a live project first. Regenerating after that deploy
      // reproduces these entries and this comment can go.
      landing_block_limit_for_plan: { Args: { p_plan_id: string }; Returns: number }
      landing_template_allowed: {
        Args: { p_plan_id: string; p_template: string }
        Returns: boolean
      }
      save_own_course_landing: {
        Args: { p_blocks: Json; p_course_id: string; p_template: string }
        Returns: undefined
      }
      // Added by hand for supabase/migrations/20260820000000_custom_domains.sql.
      // This file is normally generated by `supabase gen types`, which needs the
      // migration applied to a live project first. Regenerating after that
      // deploy reproduces these five entries and this comment can go.
      claim_custom_domain: { Args: { p_hostname: string }; Returns: string }
      custom_domain_limit_for_plan: { Args: { p_plan_id: string }; Returns: number }
      get_my_custom_domain_quota: {
        Args: Record<PropertyKey, never>
        Returns: { limit: number; used: number }[]
      }
      release_own_custom_domain: { Args: { p_id: string }; Returns: string }
      sync_own_custom_domain: {
        Args: {
