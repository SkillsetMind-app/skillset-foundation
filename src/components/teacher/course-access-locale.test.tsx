...
describe("course access with real EN/ES dictionaries", () => {
  it("requires integrated keys and translates loaded states without changing emails", async () => {
    ...
    for (const label of ["Acceso concedido", "Acceso existente conservado", "Se revocó el acceso concedido por el creador", "El acceso existente requiere revisión de soporte"]) expect(screen.getByText(label)).toBeVisible();
